...
const Main = () => {
  ...
  return (
    <Container maxWidth="xl" sx={{ py: 4, position: 'relative' }}>
      {/* Admin Mode Toggle */}
      <Tooltip title={adminMode ? "Exit Admin Mode" : "Enter Admin Mode"} placement="left">
        <Fab
          ...
          sx={{
            ...
            right: 16,
            zIndex: 1000,
            backgroundColor: adminMode ? '#9c27b0' : '#f5f5f5',
            '&:hover': {
              backgroundColor: adminMode ? '#7b1fa2' : '#e0e0e0'
            }
          }}
        >
          <SettingsIcon />
      ...
      {adminMode && (
        <Tooltip title="Add New Project" placement="left">
          <Fab
            color="primary"
